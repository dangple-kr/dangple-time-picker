part of '../dangple_time_picker.dart';
...
class KoCupertinoDatePicker extends StatefulWidget {
...
class _CupertinoDatePickerDateTimeState extends State<KoCupertinoDatePicker> {
  ...
  @override
  void didUpdateWidget(KoCupertinoDatePicker oldWidget) {
  ...
  double _getEstimatedColumnWidth(_PickerColumnType columnType) {
    estimatedColumnWidths[columnType.index] ??=
        KoCupertinoDatePicker._getColumnWidth(
...
class _CupertinoDatePickerDateState extends State<CupertinoDatePicker> {
  ...
  void _refreshEstimatedColumnWidths() {
    estimatedColumnWidths[_PickerColumnType.dayOfMonth.index] =
        KoCupertinoDatePicker._getColumnWidth(_PickerColumnType.dayOfMonth,
            localizations, context, widget.showDayOfWeek);
    estimatedColumnWidths[_PickerColumnType.month.index] =
        KoCupertinoDatePicker._getColumnWidth(_PickerColumnType.month,
            localizations, context, widget.showDayOfWeek);
    estimatedColumnWidths[_PickerColumnType.year.index] =
        KoCupertinoDatePicker._getColumnWidth(_PickerColumnType.year,
            localizations, context, widget.showDayOfWeek);
  }
